package com.example.mdp_group_24_android.Settings;
...
public class BluetoothServices {
    BluetoothActivity mBluetoothServices;
    private static BluetoothServices instance;
    private static final String TAG = "DebuggingTag";

    private static final String appName = "Group_24"; //change this
    ...
    private class ConnectThread extends Thread{
        ...
        public void run(){
            ...
            try {
                ...
                try {
                    BluetoothActivity mBluetoothActivityActivity = (BluetoothActivity) mContext;
